...
const processImage = (file) => {
  return new Promise((resolve, reject) => {
    ...
    // Safety limit 750KB to account for Base64 overhead (33%) staying under 1MB
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        try {
          ...
          // Resize if too big to help compression
          const MAX_DIM = 1024; 
          let width = img.width;
...
// =================================================================================================
// 4. MAIN DASHBOARD & AUTHENTICATED APP
// =================================================================================================
